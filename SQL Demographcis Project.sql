...
create table income 
	as (select income, count(income) from black_faith_demos bfd group by income order by count(income) desc)

select * 
from income

create table education
	as (select educcat2 as education_level from black_faith_demos bfd)
